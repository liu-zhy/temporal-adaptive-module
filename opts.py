...
parser.add_argument('--consensus_type', type=str, default='avg', choices=['avg', 'TRN', 'TRNmultiscale'])
...
parser.add_argument('--tam', default=False, action="store_true", help='use shift for models')
